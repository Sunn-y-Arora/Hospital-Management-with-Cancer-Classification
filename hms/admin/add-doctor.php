...
$nameErr = $emailErr = $passErr = $contactErr = $feeErr= $addErr= "";

if (empty($doccontactno)) {
    $contactErr = "Phone is required";
	$has_error=true;
  } else {
    
    if (!preg_match("/^[0-9]{10}$/",$doccontactno)) {
      $contactErr = "10 digit no is required"; 
	  $has_error=true;
    }
  }
...
if (empty($docaddress)) {
    ...
    $name = test_input($docaddress);
    
    if (!preg_match("/^[a-zA-Z0-9- ]+$/",$docaddress)) {
      $addErr = "Only special character allowed is "-" is allowed"; 
	  $has_error=true;
    }
  }
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												...
												<div class="panel-body">
													...
													<form role="form" name="adddoc" method="post" onSubmit="return valid();" action="<?php echo $_SERVER["PHP_SELF"];?>">
