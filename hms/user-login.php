	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../index.html"><h2> VHP | Patient Login</h2></a>
				</div>
					...
					<form class="form-login" method="post">
						<fieldset>
							...
							<div id="homebt">
								...
								<a href="http://localhost/hmsproject/main.html"><button type="button" class="btn btn-primary pull-right" name="Home">
									Home <i class="fa fa-arrow-circle-left"></i>
								</button></a>
							</div>	
